...
int main(int argc, char **argv)
{
  ...
  robot.addAction(&avoidFrontNear, 16); //Se hicieron cambios en los valores de FrontNear y FrontFar, tambien en la velocidad para ajustarlo a un rango corto de reaccion.
  robot.addAction(&avoidFrontFar, 27);
